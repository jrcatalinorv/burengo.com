...
<div class="card">
              <div class="card-header">
                <h3 class="card-title"> <i class="fas fa-building"></i> Informaciones Generales </h3>
              </div>
              <!-- form start -->
              <form role="form">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="name" value="<?php echo $results["cpname"]; ?>" />
                  </div>
                 
				 <div class="form-group">
                    <label for="mail"> Correo </label>
                    <input type="text" class="form-control" id="mail" value="<?php echo $results["cpemail"]; ?>" />
                  </div>                 
				 
				 <div class="form-group">
                    <label for="addr"> Dirección </label>
                    <input type="text" class="form-control" id="addr" value="<?php echo $results["cpaddr"]; ?>" />
                  </div>
        
                 <div class="form-group">
                    <label for="phone"> Teléfono  </label>
                    <input type="text" class="form-control" id="phone"  data-inputmask='"mask": "(999) 999-9999"' data-mask  value="<?php echo $results["cpphone"]; ?>" />
                  </div>
                </div>
                <!-- /.card-body -->
...
$.getJSON('ajax/burengo_update_infoCompany.php',{
		nm: $('#name').val(),
		ml: $('#mail').val(),
		ad: $('#addr').val(),
		ph: $('#phone').val()
