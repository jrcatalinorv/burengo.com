		...
		<div class="col-md-11">
					...
					<div class="col-sm-6">
                      <div class="form-group">
                        <select id="condition" class="form-control">
                          <option option="N/A"> Condicion del vehiculo </option>
                          <option option="Nuevo"> Nuevo </option>
                          <option option="Usado"> Usado </option>
                        </select>                    
					</div>
                    </div>
                  </div>
			...
			<div class="row">
                  ...
                  <select id="cartype" class="form-control">
						...
						<option option="1"> Sedan   </option>
						<option option="2"> Compacto  </option> 
						<option option="3"> Jeepeta  </option>
						<option option="4"> Camioneta  </option>
						<option option="5"> Coupe/Sport  </option>
						<option option="6"> Motores  </option>
						<option option="7"> Camiones  </option>
						<option option="8"> Autobuses  </option>
						<option option="9"> Vehiculos Pesados  </option>
						<option option="10"> Otros  </option>
                    </select> 
                </div>                     
					</div>
                    </div>
					...
					<div class="col-sm-6">
                      <div class="form-group">
                        <select id="trasnmision" class="form-control">
                          ...
                          <option option="1"> Automatica </option>
                          <option option="2"> Manual </option>
                          <option option="3"> Triptonica </option>
                        </select>                    
					</div>
                    </div>					
