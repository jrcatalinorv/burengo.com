...
bgo_puertas_cantidad,bgo_pasajeros_cantidad,bgo_addr,bgo_accesories,bgo_notes,bgo_status) VALUES (:bgo_code,
		:bgo_txdate,:bgo_txtime,:bgo_usercode,:bgo_cat,:bgo_subcat,:bgo_title,:bgo_price,
		...
		:bgo_pasajeros_cantidad,:bgo_addr,:bgo_accesories,:bgo_notes,:bgo_status)");
