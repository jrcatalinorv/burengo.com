...
<div class="wrapper">
  ...
  <!-- Right navbar links -->
    <ul class="navbar-nav ml-auto">
 	<li class="nav-item dropdown" data-toggle="modal" data-target="#catmodal"><a class="nav-link"  href="#"><i class="fas fa-plus-circle"></i>  Provincia </a></li>
...
$('#categoryBody').load('../../ajax/burengo_places_lista.php'); 	   
});
