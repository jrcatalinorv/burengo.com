        ...
        <div class="modal-dialog">
          <div class="modal-content">
			...
			<div class="btn-group btn-group-lg col-md-12">
				<button id="mopv1" class="btn btn-sm btn-warning"><i class="fas fa-wallet"></i> Vender </button>
				<button id="mopv2" class="btn btn-sm btn-default"> <i class="far fa-calendar-alt"></i> Rentar </button>
			</div>
			<hr/>
			<div class="btn-group btn-group-lg col-md-12">
				<button id="mop1" class="btn btn-sm btn-warning"><i class="fa fa-car"></i> Vehiculos </button>
				<button id="mop2" class="btn btn-sm btn-default"> <i class="fa fa-th"></i> Inmuebles </button>
			</div>
		</div>
