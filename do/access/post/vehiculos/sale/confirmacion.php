              ...
              <p>  </p>
				...
				<div class="p-0">
					<table class="table table-sm">
                         <tbody>
							<tr>
								<td><label> Marca:</label></td><td> <?php echo $fullbrand; ?></td> 
								<td><label> Modelo:</label></td><td><?php echo $modelo; ?></td> 											
                            </tr>							
							<tr>
                                <td><label> Condicion:</label></td><td> <?php echo $condition; ?></td> 
								<td><label> Año:</label></td><td><?php echo $year; ?></td> 											
                            </tr>
                           <tr>
                              <td><label>Color:</label></td><td><?php echo $color; ?></td> 
                              <td><label>Tipo:</label></td><td><?php echo $tipo; ?></td> 
                           </tr>
                           <tr>
                               <td><label>Interior:</label></td><td><?php echo $color2; ?></td> 
                               <td><label>Combustible: </label></td><td><?php echo $fuel; ?></td>
                           </tr>
                           <tr>
                               <td><label>Transmisión:</label></td><td><?php echo $transmission; ?></td> 
							   <td><label>Puertas:</label></td><td><?php echo $doors; ?></td>
                            </tr>
                                        <tr>
