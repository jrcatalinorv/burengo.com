    ...
    <div class="card-body login-card-body">
      ...
      <div action="#"><br/>
        <div class="input-group mb-3 pt-3">
          <input id="email" type="email" class="form-control" placeholder="Digite su cuenta de correo" />
        ...
        <div class="row pt-3">
          <div class="col-12">
            <button id="send" type="button" class="btn btn-success btn-block"> Recuperar Contrasena </button>
          </div>
        </div>
      </div>

      <div class="social-auth-links text-center mb-3">
        <a href="../do" class="btn btn-block btn-info"> Cancelar </a>         
		</div>  
    </div>
  </div>
</div>
