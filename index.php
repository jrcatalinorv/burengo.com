...
echo '<div class="col-lg-3 col-md-6 visit mb-3 itemSelection" itemId="'.$results['bgo_code'].'" itemCat="'.$results['bgo_subcat'].'" data-aos="fade-up">';
...
$('.plist').on("click", "div.itemSelection", function(){ 
	...
	switch(cat){
		case '1': location.href="itemview.php?dtcd="+id; break;
		case '2': location.href="itemnview.php?dtcd="+id; break;
	} 
}); 
